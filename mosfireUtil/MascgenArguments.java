...
public class MascgenArguments {
  ...
  public static final String XML_STEPS_ATTRIBUTE_PA_STEP_SIZE = "paStepsSize";
	...
	//////////////////////////////////////////////////////////////////
	// Part of MAGMA UPGRADE item M4 by Ji Man Sohn, UCLA 2016-2017 //
	public static final String XML_OUTPUT_ATTRIBUTE_EXCESS_TARGETS = "excessTargets";
	//////////////////////////////////////////////////////////////////
	...
	public MascgenArguments() {
		this("default");
	}

	public MascgenArguments(String maskName) {
	...
	public MascgenArguments(String maskName, String targetList, double xRange, double xCenter,
	...
	public MascgenArguments(String maskName, String targetList, double xRange, double xCenter,
			...
			String outputMaskTargets, String outputExcessTargets, String outputMSC, String outputAlignMSC,
  ...
  private String getFullPath(String filename) {
	...
	public static MascgenArguments readMascgenParamFile(File paramFile, ArrayList<String> outWarningList) throws JDOMException, IOException, DataConversionException {
	...
	public static MascgenArguments getMascgenArgsFromElement(Element root, ArrayList<String> outWarningList)  throws JDOMException, DataConversionException {
		...
		MascgenArguments args = new MascgenArguments();
	...
	public static void writeMascgenParamFile(File file, MascgenArguments args) throws JDOMException, IOException {
		//. todo: versioning?    
	...
	public static Element getMascgenArgumentsRootElement(MascgenArguments args) {
